...
const FeedbackBox = () => {
  return (
    <div className="bg-[#FDF5F4] p-3 rounded-lg absolute right-0 z-[100] w-[280px] ">
      ...
      <h1 className="text-lg text-[#EC583C] ">Title Suggestion</h1>
      <p className="text-[#252530]/70">sacdscdscdscsdfvfsvfsvsv</p>
      <h1 className="text-lg text-[#EC583C] ">Section Suggestion:</h1>
