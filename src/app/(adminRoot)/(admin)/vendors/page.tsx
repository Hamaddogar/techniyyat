    ...
    <div className="bg-white max-md:p-2 p-7 rounded-xl">
      <div className="flex items-center justify-between border-b border-gray-200 ">
        ...
        <div className="flex gap-4 max-lg:text-[10px] text-[#252530]/50">
          <button className="border px-3 max-md:text-[9px] text-sm p-1 rounded-full border-gray-100">
            Select Category
          </button>
          <button className="border max-md:text-[9px] bg-[#EC583C]  text-sm p-2 text-white rounded-full border-gray-100">
            Add New Vendor
          </button>
        </div>
      </div>
