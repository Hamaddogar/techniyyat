...
import { HeadingAndDesc, ProductDetail } from "@/components/ProductPage";
...
import { Reviews, SuggestSection } from "@/sections/ProductPage";
    ...
    <div className="relative  ">
      ...
      <div className="max-w-[1440px] p-2 mx-auto ">
        ...
        <div className="flex items-center gap-4 text-xl mt-4">
          <Link href={"/registeredUser/vendor/num"}>Vendors</Link>
          <Link
            href={"/registeredUser/product/num"}
